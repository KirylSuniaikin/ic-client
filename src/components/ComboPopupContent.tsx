...
import type { CartItem, Group } from '../management/types/menuTypes';
...
function ComboPopup({
    ...
    const [item, setItem] = useState<import('../management/types/menuTypes').MenuItem | null>(null);
    ...
    function handleTogglePizza(pizzaName: string, checked: boolean): void {
    ...
    function handleChangeNote(pizzaName: string, note: string): void {
    ...
    function updatePizzaConfig(pizzaName: string, index: number, key: string, value: string): void {
        setSelectedPizzas(prev =>
            prev.map((p, i) =>
    ...
    function handleQuantityChange(pizzaName: string, delta: number): void {
        setSelectedPizzas(prev => {
