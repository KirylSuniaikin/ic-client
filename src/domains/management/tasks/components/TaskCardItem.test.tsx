...
describe("TaskCardItem", () => {
    ...
    it("always renders the title", () => {
        render(<TaskCardItem card={makeCard()} onClick={jest.fn()} onChangePriority={jest.fn()} />);

        expect(screen.getByText("Restock mozzarella")).toBeTruthy();
    });

    it("renders the description block when description is present", () => {
        render(<TaskCardItem card={makeCard({ description: "Buy more cheese" })} onClick={jest.fn()} onChangePriority={jest.fn()} />);
    ...
    it("clicking the card body calls onClick with the card", () => {
        ...
        const card = makeCard();
        render(<TaskCardItem card={card} onClick={onClick} onChangePriority={jest.fn()} />);
    ...
    it("clicking the three-dots icon does not call onClick", () => {
        const onClick = jest.fn();
        render(<TaskCardItem card={makeCard()} onClick={onClick} onChangePriority={jest.fn()} />);
