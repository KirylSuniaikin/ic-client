...
import {sendShiftEvent} from "../../../../shared/api/public";
import type { ShiftEventType } from "../../../order/types";
...
export default function ShiftPopup({isOpen, onClose, stage, branchId}: ShiftPopupProps): JSX.Element {
    const [checklist, setChecklist] = useState<ChecklistItem[]>([]);

    const handleCheck = (index: number) => { const updated = [...checklist]; updated[index].done = !updated[index].done; setChecklist(updated); };
    ...
    const getStageTitle = (stageValue: ShiftEventType): JSX.Element | string => {
        switch (stageValue) {
