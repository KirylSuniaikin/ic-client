...
import {getTimeUntilNextOpening} from "./getTimeUntilNextOpening"; // путь к JSON-анимации
        ...
        <Modal open={open} onClose={onClose}>
            ...
            >
                ...
                <Typography variant="h6" sx={{ mt: -2, fontWeight: "bold", color: "#E44B4C" }}>
                    Unfortunately you can't place an order right now
                </Typography>

                {!nextOpeningMessage && (
                <Typography sx={{ mt: 1.5, fontSize: 16 }}>
                    Time left until you can enjoy our pizza:
                </Typography>
                )}
